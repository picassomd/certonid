...
func genCertFromAws(client *awscloud.Client, awsRegion string, awsFuncName string, keyData []byte, kmsauthToken string, timeout int) ([]byte, error) {
	...
	lambdaClient := client.LambdaClient(awsRegion)
